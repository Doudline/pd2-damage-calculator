...
class CharSkill():
    ...
    def __init__(self):
        ...
        self.spell = {'ama': ['Magic Arrow', 'Fire Arrow', 'Cold Arrow', 'Power Strike', 'Poison Javelin', 'Exploding Arrow', 'Lightning Bolt', 'Ice Arrow', 'Charged Strike', 'Plague Javelin', 'Immolation Arrow', 'Freezing Arrow', 'Lightning Strike', 'Lightning Fury'], 'sor': ['Fire Bolt', 'Charged Bolt', 'Ice Bolt', 'Inferno', 'Telekinesis', 'Frost Nova', 'Ice Blast', 'Blaze', 'Fire Ball', 'Nova', 'Lightning', 'Shiver Armor', 'Fire Wall', 'Chain Lightning', 'Glacial Spike', 'Meteor', 'Thunder Storm', 'Blizzard', 'Chilling Armor', 'Hydra', 'Frozen Orb', 'Ice Barrage', 'Combustion', 'Lesser Hydra'], 'nec': ['Teeth', 'Poison Dagger', 'Corpse Explosion', 'Desecrate', 'Bone Spear', 'Poison Nova', 'Bone Spirit'], 'pal': ['Holy Bolt', 'Holy Fire', 'Blessed Hammer', 'Holy Freeze', 'Holy Shock', 'Sanctuary', 'Fist of the Heavens', 'Holy Nova', 'Holy Light'], 'bar': ['War Cry'], 'dru': ['Firestorm', 'Molten Boulder', 'Arctic Blast', 'Eruption', 'Rabies', 'Fire Claws', 'Twister', 'Shock Wave', 'Volcano', 'Tornado', 'Armageddon', 'Hurricane'], 'ass': ['Fire Trauma', 'Psychic Hammer', 'Shock Field', 'Fists of Fire', 'Cobra Strike', 'Charged Bolt Sentry', 'Wake of Fire Sentry', 'Claws of Thunder', 'Chain Lightning Sentry', 'Inferno Sentry', 'Mind Blast', 'Blades of Ice', 'Royal Strike', 'Death Sentry', 'Lightning Sentry']}
        ...
        self.sorc_masteries = {"Fire Mastery": [(20, 4), (1, 1, 30)], "Cold Mastery": [(10, 2), (5, 1, 45)], "Lightning Mastery": [(50, 12), (0,0, 0)]}
        self.file = None
